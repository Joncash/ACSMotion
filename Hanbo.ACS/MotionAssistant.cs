...
namespace Hanbo.ACS
{
	...
	public class MotionAssistant
	{
		...
		private int _YLoop;
		private int _XLoop;
		private double _YMovePixels;
		private double _XMovePixels;
		...
		public MotionAssistant(MotionController motionController)
		{
			...
			initMotionBackgroundWorker();
		}
		#endregion

		#region MotionBackground Event Methods
		private void initMotionBackgroundWorker()
		{
		...
		public void RunPEG(int yWayLoop, int xWayLoop, double yWayMovePixel, double xWayMovePixel)
		{
			_YLoop = yWayLoop;
			_XLoop = xWayLoop;
			_YMovePixels = yWayMovePixel;
			_XMovePixels = xWayMovePixel;
			if (!_bgWorker.IsBusy)
			{
